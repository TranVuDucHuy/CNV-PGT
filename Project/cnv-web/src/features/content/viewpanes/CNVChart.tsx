        ...
        <ResponsiveContainer>
          ...
          >
            ...
            <YAxis
              ...
              label={{ value: 'Copy number', angle: -90, position: 'insideLeft' }}
            />
            ...
            <Tooltip
              ...
              content={({ active, payload }) => {
                if (active && payload && payload.length) {
                  ...
                  if (data.raw) { // Đây là Bin
                     return (
                        <Paper sx={{ p: 1, border: '1px solid #ccc' }}>
                           <Typography variant="body2">Chr: {data.raw.chromosome}</Typography>
                           <Typography variant="body2">Pos: {data.raw.start} - {data.raw.end}</Typography>
                           <Typography variant="body2">CN: {data.raw.copy_number.toFixed(2)}</Typography>
                        </Paper>
                     )
                  }
                }
            ...
            <ReferenceLine y={1} stroke="lightblue" strokeDasharray="3 3" label={{ value: '1n', position: 'right', fill: 'gray', fontSize: 10 }} />
            <ReferenceLine y={2} stroke="gray" strokeWidth={1} label={{ value: '2n', position: 'right', fill: 'gray', fontSize: 10 }} />
            <ReferenceLine y={3} stroke="pink" strokeDasharray="3 3" label={{ value: '3n', position: 'right', fill: 'gray', fontSize: 10 }} />
